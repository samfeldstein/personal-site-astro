...
export const workHistory = {
  ...
  devSentinel: {
    ...
    place: "Marfa, TX",
    description: [
      "Designed, developed, and launched an e-commerce platform using WordPress and WooCommerce, enhancing the business's digital presence and revenue potential.",
